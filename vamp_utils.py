...
def load_static_mnist(args, **kwargs):
    ...
    with open(os.path.join('/home/zo122/datasets', 'MNIST_static', 'binarized_mnist_train.amat')) as f:
        lines = f.readlines()
    x_train = lines_to_np_array(lines).astype('float32')
    with open(os.path.join('/home/zo122/datasets', 'MNIST_static', 'binarized_mnist_valid.amat')) as f:
        lines = f.readlines()
    x_val = lines_to_np_array(lines).astype('float32')
    with open(os.path.join('/home/zo122/datasets', 'MNIST_static', 'binarized_mnist_test.amat')) as f:
        lines = f.readlines()
