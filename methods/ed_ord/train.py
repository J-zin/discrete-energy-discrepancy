...
from methods.ed_ord.model import MLPScore, EBM
from methods.ed_ord.loss import compute_loss, compute_transition_matrix
...
def main(args, verbose=False):
    ...
    qt_matrix = compute_transition_matrix(args, t_noise=args.cat_tnoise, ord=True)
    for epoch in range(args.num_epochs):
        ...
        for it in pbar:
            ...
            loss = compute_loss(model, samples, qt_matrix, args)
