...
from methods.ed_ord.models.model import MLPScore, EBM
from methods.ed_ord.models.loss import compute_loss, compute_transition_matrix
...
class Trainer:
    def __init__(self, model, train_iter, lr, weight_decay, steps, model_save_path, device=torch.device('cuda:1'), args=None):
        ...
        self.qt_matrix = compute_transition_matrix(args, t_noise=args.tnoise, ord=True)
