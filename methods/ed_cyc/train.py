...
from methods.ed_cyc.model import MLPScore, EBM
from methods.ed_cyc.loss import compute_loss, compute_transition_matrix
...
def main(args, verbose=False):
    ...
    qt_matrix = compute_transition_matrix(args, t_noise=args.cat_tnoise)
